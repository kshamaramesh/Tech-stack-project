...
def postgres_to_s3(ds_nodash, next_ds_nodash):
    ...
    with open(f"dags/get_orders_.txt", "w") as f:
    ...
    cursor.close()
    conn.close()
    logging.info("Saved orders data in text file: %s", f"/home/kshama-ramesh/kshama_dev/Tech-stack-project/dags/get_orders_{ds_nodash}.txt")
